...
<div class="nav" style="background-color:silver; display: flex; justify-content: space-between; align-items: center; padding: 10px;">
    ...
    <a href="http://localhost/php_ecommerce" style="color: black; font-weight: bold; text-decoration: none;"><u>USER LOGIN</u></a>
</div><br><br>
<div class="container">
    <div class="card" style="padding: 20px; width:500px; margin-left:300px; border: 1px solid #ccc; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
        <h1 style=" margin-left:130px;"  >ADMIN Login</h1>
        <br><br>
        ...
        if(isset($_POST['sub'])) {
            ...
            $ps = mysqli_real_escape_string($link, $_POST['ps']);

            // Using the correct column names
            $q = "SELECT * FROM admin WHERE un = '$un' AND ps = '$ps'";
            $run = mysqli_query($link, $q);

            if ($row = mysqli_fetch_array($run)) {
                echo "Login successful! Welcome " . $row['un'];
            } else {
