                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="mystyle">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="index1.php" style="color:black;">Help</a>
                            </li>
                        </ul>
                    </div>
                </nav>
    ...
    <div class="row" style="margin: 0;">
        ...
        <div class="col-sm-10" style="padding: 10px;">
            <div class="container" style="padding: 20px;">
                <h1 class="text-center" style="font-size: 36px; margin-top: 20px;">About Us</h1>
                <p style="font-size: 18px; line-height: 1.6; margin-top: 20px;">
                    Welcome to MY SHOP, your number one source for all things tech. We're dedicated to giving you the very best of electronics, with a focus on dependability, customer service, and uniqueness.
                </p>
                <p style="font-size: 18px; line-height: 1.6;">
                    Founded in 2023, MY SHOP has come a long way from its beginnings in a home office. When we first started out, our passion for helping people find the best products drove us to do intense research, and gave us the impetus to turn hard work and inspiration into a booming online store. We now serve customers all over the world, and are thrilled to be a part of the tech industry.
                </p>
                <p style="font-size: 18px; line-height: 1.6;">
